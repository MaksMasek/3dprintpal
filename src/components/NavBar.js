...
import { WhatsAppIcon, InstagramIcon, SunIcon, MoonIcon } from "./icons";
            ...
            <span className={`bg-dark dark:bg-light block transition-all duration-300 ease-out h-0.5 w-6 rounded-sm  ${isOpen ? '-rotate-45 -translate-y-1' : 'translate-y-0.5'}`}></span>
                ...
                <div className="w-full flex justify-between items-center lg:hidden">
                      <nav>
                        ...
                        <CustomLink href="/my-mission" title="My mission" className="mx-4" />
                        <CustomLink href="/how-it-works" title="How it works" className="mx-4" />
                        <CustomLink href="/projects" title="Projects" className="ml-4" />
                      </nav>
                      
                      <nav className="flex items-center justify-center flex-wrap">
                        <motion.a
                          href="https://wa.me/393515952403"
                          target={"_blank"}
                          whileHover={{ y: -2 }}
                          whileTap={{ scale: 0.9 }}
                          className="w-6 mr-3"
...
{
  isOpen ?
  <motion.div className="min-w-[60vw] flex flex-col justify-between z-30 items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
  ...
  >
        <nav className="flex items-center flex-col justify-center">
          ...
          <CustomMobileLink href="/my-mission" title="My mission" className="" toggle={handleClick}/>
          <CustomMobileLink href="/how-it-works" title="How it works" className="" toggle={handleClick}/>
  ...
  : null
        ...
        <div className="absolute left-[50%] translate-x-[-45%] transform transition-transform scale-90">
          <Logo />
        </div>
